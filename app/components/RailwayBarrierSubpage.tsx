...
function RailwaySubpageContent({ data }: { data: RailwaySubpageProps }) {
  ...
  const [activeTab, setActiveTab] = useState<"blueprint" | "calculator" | "casestudies" | "specs">("blueprint");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f8fafc] text-slate-800 font-sans selection:bg-[#0284c7] selection:text-white">
      ...
      {/* 
        =======================================================================
        HERO SECTION: CAD BLUEPRINT & RAILWAY HARDWARE ACCENT
        =======================================================================
      */}
      <section className="relative w-full pt-28 sm:pt-36 pb-16 sm:pb-20 bg-gradient-to-b from-slate-100 via-[#f8fafc] to-white border-b border-slate-200 overflow-hidden">
        ...
        <div className="absolute -top-24 right-10 w-96 h-96 bg-sky-200/40 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <nav className="flex items-center space-x-2 text-xs font-medium text-slate-500 mb-6" aria-label="Breadcrumb">
            ...
            <span>/</span>
            <Link href="/products/railway-barrier" className="hover:text-sky-600 transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                >
                  <span className="text-[11px] font-mono font-bold text-sky-600">DWG</span>
                  <span>{lang === "hi" ? "CAD एवं टेंडर स्पेक्स" : "CAD DWG & Tender Specs"}</span>
                </a>
              </div>
            </div>

            {/* Right Hero Image Card with Technical Overlay */}
            <div className="lg:col-span-5">
              <div className="relative overflow-hidden bg-white p-2 shadow-lg border border-slate-200 group">
      ...
      {/* 
        =======================================================================
        SECTION 2: DEEP DIVE & MECHANICAL HIGHLIGHTS (Blueprint Breakdown)
        =======================================================================
      */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-12">
            <span className="text-xs font-bold font-mono text-sky-600 uppercase tracking-widest">
              {lang === "hi" ? "कोर मैकेनिकल आर्किटेक्चर" : "CORE MECHANICAL ARCHITECTURE"}
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-7 space-y-4 text-slate-600 text-sm sm:text-base leading-relaxed">
              {(lang === "hi" ? data.deepDiveParasHi : data.deepDiveParasEn).map((p, idx) => (
                <p key={idx} className="bg-slate-50/70 p-4 rounded-xl border border-slate-100">
                  {p}
                </p>
              ))}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
                {data.highlights.map((h, i) => (
                  <div key={i} className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-sky-300 transition-all">
                    <span className="inline-block px-2 py-0.5 rounded bg-sky-100 text-sky-800 text-[10px] font-bold font-mono uppercase mb-2">
                      {h.badge}
                    </span>
            ...
            <div className="lg:col-span-5">
              <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-white p-5 sm:p-6">
                <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                  <span className="text-xs font-bold text-slate-800 tracking-wide uppercase">Technical Specification</span>
                  <span className="text-[11px] px-2.5 py-0.5 rounded bg-emerald-50 text-emerald-700 font-medium border border-emerald-200">Certified EN 50126</span>
                </div>
                
                <div className="relative my-4 h-48 overflow-hidden border border-slate-200">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                ...
                <div className="divide-y divide-slate-100 text-xs">
                  <div className="flex justify-between py-2.5">
                    ...
                    <span className="text-emerald-700 font-semibold">&lt; 10 ms (Fail-Safe)</span>
                  </div>
                  <div className="flex justify-between py-2.5">
      ...
      {/* 
        =======================================================================
        BANNER 1 (~80% WIDTH): TECHNICAL ARCHITECTURE SPOTLIGHT
        =======================================================================
      */}
      ...
      {/* 
        =======================================================================
        SECTION 3: INTERACTIVE BOOM SIZING & WIND LOAD BENCH (NO REPETITION)
        =======================================================================
      */}
      <section id="engineering-bench" className="py-16 sm:py-20 bg-slate-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <span className="px-3 py-1 rounded bg-sky-100 text-sky-800 text-xs font-bold font-mono uppercase">
              {lang === "hi" ? "इंटरएक्टिव इंजीनियरिंग सिमुलेशन" : "INTERACTIVE SIZING SIMULATOR"}
            </span>
            ...
            <div className="lg:col-span-6 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
              <div>
                <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider mb-6 flex items-center justify-between">
                  ...
                  <span className="text-xs font-mono text-sky-600">LIVE FEEDBACK</span>
                </h3>
                ...
                <div className="mb-6">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm font-bold font-mono text-sky-600 bg-sky-50 px-2 py-0.5 rounded border border-sky-200">
            ...
            <div className="lg:col-span-6 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
              <div>
                <div className="flex justify-between items-center pb-4 border-b border-slate-100">
                  ...
                  <span className="text-[10px] px-2.5 py-0.5 rounded bg-sky-50 text-sky-700 font-mono font-bold border border-sky-200">
                    EN 50126 READY
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 my-6">
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200">
                    ...
                    <div className="text-2xl font-bold font-mono text-sky-600 mt-1">{cycleTime} sec</div>
              ...
              <div className="pt-6 border-t border-slate-100 flex items-center justify-between mt-6">
                ...
                <a
                  href="#spec-drawer"
                  className="px-4 py-2 rounded-lg bg-sky-700 hover:bg-sky-800 text-white text-xs font-semibold tracking-wide transition-all shadow-sm"
                >
      ...
      {/* 
        =======================================================================
        BANNER 2 (FULL-WIDTH): FIELD INSTALLATION & COMMISSIONING SHOWCASE
        =======================================================================
      */}
      ...
      */}
      <section className="py-16 sm:py-20 bg-white border-b border-slate-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-10">
            <span className="text-xs font-bold font-mono text-sky-600 uppercase tracking-widest">
              {lang === "hi" ? "प्रमाणित विनिर्देश" : "VERIFIED PARAMETERS"}
            </span>
              ...
              <tbody className="divide-y divide-slate-100 text-slate-600">
                {data.specsTable.map((sp, idx) => (
                  <tr key={idx} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="p-4 sm:p-5 font-mono text-sky-700 font-medium">
      ...
      {/* 
        =======================================================================
        SECTION 6: BESPOKE RAILWAY ENGINEERING DRAWER (NO GENERIC 4-FIELD FORM)
        =======================================================================
      */}
      <section id="spec-drawer" className="py-16 sm:py-20 bg-gradient-to-b from-slate-50 to-slate-100 border-b border-slate-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="p-8 sm:p-12 rounded-3xl bg-white border border-slate-200 shadow-lg shadow-slate-200/50">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              
              {/* Left Column: Direct Downloads & Quick Access */}
              <div className="lg:col-span-7">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-6">
                  {[
                    ...
                    <button
                      ...
                      className="p-3 rounded-xl bg-slate-50 hover:bg-sky-50 border border-slate-200 hover:border-sky-300 text-left transition-all flex flex-col justify-between cursor-pointer group"
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs text-slate-400 group-hover:text-sky-600">↓</span>
                      </div>
                      <div className="mt-2">
              ...
              <div className="lg:col-span-5 bg-white p-6 sm:p-7 rounded-2xl border border-slate-200 shadow-sm text-slate-900">
                ...
                <div className="mt-5 space-y-2.5">
                  <a
                    ...
                    className="w-full py-3 px-4 rounded-xl bg-sky-700 hover:bg-sky-800 text-white text-xs font-semibold flex items-center justify-between transition-all shadow-sm"
                  >
                    <span>TEL: +91 11 4988 7700</span>
                    <span className="text-[10px] bg-sky-800 px-2 py-0.5 rounded font-medium">NEW DELHI HQ</span>
                  </a>
                  <a
                    href="mailto:rail.engineering@global-safety.com"
                    className="w-full py-3 px-4 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-800 text-xs font-semibold flex items-center justify-between transition-all"
                  >
