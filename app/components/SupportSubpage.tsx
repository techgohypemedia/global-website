...
function SupportContent({ data }: { data: SupportSubpageProps }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f8fafc] text-slate-800 font-sans selection:bg-[#0284c7] selection:text-white">
      ...
      {/* 
        =======================================================================
        HERO SECTION: TECHNICAL DOCUMENTATION KNOWLEDGE BASE PORTAL
        =======================================================================
      */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <nav className="flex items-center space-x-2 text-xs font-medium text-slate-500 mb-6" aria-label="Breadcrumb">
            ...
            <Link href="/support" className="hover:text-sky-600 transition-colors">
              {lang === "hi" ? "तकनीकी सहायता एवं दस्तावेज़" : "Technical Support"}
            </Link>
            <span>/</span>
            ...
            <div className="lg:col-span-7">
              ...
              <div className="relative max-w-lg mb-6">
                <input
                  ...
                  className="w-full px-4 py-3.5 pl-11 rounded-xl bg-white border border-slate-300 text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500 shadow-sm"
                />
      ...
      {/* 
        =======================================================================
        BANNER 1 (~80% WIDTH): TECHNICAL DOCUMENTATION SPOTLIGHT
        =======================================================================
      */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-4">
              <div className="inline-flex items-center space-x-2 px-3 py-1 bg-sky-100 text-sky-800 border border-sky-200 text-xs font-bold uppercase tracking-wider font-mono">
                <span>{lang === "hi" ? "तकनीकी दस्तावेज़" : "TECHNICAL RESOURCE"}</span>
                <span>•</span>
                <span>2026 REVISION VAULT</span>
              </div>
      ...
      {/* 
        ...
        =======================================================================
      */}
      <section id="document-vault" className="py-16 sm:py-20 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <span className="text-xs font-bold font-mono text-sky-600 uppercase tracking-widest">
                {lang === "hi" ? "दस्तावेज़ तालिका" : "DOWNLOADABLE DOCUMENT VAULT"}
              </span>
          ...
          {downloadNotice && (
            <div className="mb-6 p-4 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs font-medium flex items-center justify-between">
              ...
              <span className="text-[10px] font-mono text-emerald-600 font-bold">DOWNLOADING</span>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {filteredDocs.map((doc, idx) => (
              <div
                key={idx}
                className="p-6 rounded-2xl bg-slate-50 border border-slate-200 hover:border-sky-300 hover:shadow-md transition-all flex flex-col justify-between"
              >
                <div>
                ...
                <div className="mt-6 pt-4 border-t border-slate-200 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-sky-600 hover:bg-sky-500 text-white text-xs font-semibold tracking-wide transition-all cursor-pointer flex items-center space-x-1.5"
                  >
                    <span>Download</span>
                    <span>↓</span>
                  </button>
      ...
      {/* 
        =======================================================================
        SECTION 3: INTERACTIVE TERMINAL WIRING & PINOUT EXPLORER (If Available)
        =======================================================================
      */}
        ...
        <section className="py-16 sm:py-20 bg-slate-50 border-b border-slate-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                {data.wiringPinouts.map((pin, idx) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-bold text-sky-700">{pin.pin}</span>
              ...
              <div className="lg:col-span-7 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm text-slate-900">
      ...
      */}
      <section className="py-16 sm:py-20 bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-10">
            <span className="text-xs font-bold font-mono text-sky-600 uppercase tracking-widest">
              {lang === "hi" ? "अक्सर पूछे जाने वाले प्रश्न" : "TECHNICAL & FIELD FAQS"}
            </span>
      ...
      {/* 
        =======================================================================
        SECTION 5: BESPOKE CONTRACTOR HOTLINE & ZIP BUNDLE (NO REPEATED FORM)
        =======================================================================
      */}
      <section className="py-16 sm:py-20 bg-white border-b border-slate-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="p-8 sm:p-12 rounded-3xl bg-slate-50 text-slate-900 border border-slate-200 shadow-md">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <button
                    ...
                    className="px-6 py-3 rounded-xl bg-sky-700 hover:bg-sky-800 text-white text-xs sm:text-sm font-bold transition-all shadow-sm cursor-pointer flex items-center space-x-2"
                  >
                  ...
                  <a
                    ...
                    className="px-5 py-3 rounded-xl bg-white hover:bg-slate-100 text-slate-800 text-xs sm:text-sm font-semibold transition-all border border-slate-200"
                  >
              ...
              <div className="lg:col-span-5 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm text-slate-900">
                <span className="text-[10px] font-bold text-emerald-700 uppercase">24/7 SITE HOTLINE</span>
                ...
                <div className="mt-4 pt-3 border-t border-slate-100">
                  <div className="text-lg font-bold text-sky-700">+91 11 4988 7700</div>
